...
print("https://discord.gg/MDt5HNQ2")
toclipboard("https://discord.gg/MDt5HNQ2")
...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("vitor hub / kaitun Premium Scripts") then
			makefolder("vitor hub / kaitun Premium Scripts")
		end
		if not isfolder("vitor hub / kaitun Premium Scripts/Blox Fruits/") then
			makefolder("vitor hub / kaitun Premium Scripts/Blox Fruits/")
		end
		if not isfile("vitor hub / kaitun Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("vitor hub / kaitun Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("vitor hub / kaitun Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("vitor hub / kaitun Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("vitor hub / kaitun Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
